...
namespace qwm
{
    ...
    namespace projection
    {
        ...
        /**
         * Implementation of the Spherical Mercator projection.
         */
        class QWIDGETMAP_EXPORT ProjectionSphericalMercator : public Projection
        {
        ...
        public:
             ...
             */
            ProjectionSphericalMercator() = default;
